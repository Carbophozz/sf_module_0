...
def game_core_v3(number):
    ...
    while number != predict:
        ...
        '''делим шаг пополам, с защитой от промаха, если вдруг шаг окажется равным 3
        можно было бы просто проверять - если шаг не равен 3, то пополам
        а если равен, то минус один, но так симпатичнее, а среднее количество шагов такое же'''
        step = (step + step % 2) // 2
